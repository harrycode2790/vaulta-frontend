...
export const duoSavingsApi = {
  ...
  rejectInvite:         (inviteId)            => api.patch(`/api/duoSavings/reject-invite/${inviteId}`),
  ...
  getDepositHistory:    (duoSavingsId)        => api.get(`/api/duoSavings/duo-savings-deposit-history/${duoSavingsId}`),
};
...
export const familySavingsApi = {
  ...
  rejectInvite:         (inviteId)      => api.patch(`/api/familySavings/reject-invite/${inviteId}`),
  ...
  getDepositHistory:    (planId)        => api.get(`/api/familySavings/family-savings-deposit-history/${planId}`),
};
...
export const authApi = {
  ...
  getMyTransactions:   ()         => api.get('/api/auth/my-transactions'),
