import { adminToken } from './tokenStorage';
...
export const adminApi = {
  ...
  getPaymentWallets:   ()              => r.get('/api/admin/payment-wallets'),
  updatePaymentWallet: (network, body) => r.patch(`/api/admin/payment-wallets/${network}`, body),
};
